...
const AnimatedButton = forwardRef(({ 
  ...
  const styleVariants = {
    ...
    icon: 'p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800',
  };
...
export const IconButton = forwardRef(({ 
  ...
  const colors = {
    slate: 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700',
