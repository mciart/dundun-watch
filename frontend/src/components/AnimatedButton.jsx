...
const AnimatedButton = forwardRef(({ 
  ...
  const styleVariants = {
    ...
    secondary: 'bg-slate-200/80 dark:bg-[#2a2a2a] text-slate-900 dark:text-slate-100 hover:bg-slate-300 dark:hover:bg-[#333]',
...
export const IconButton = forwardRef(({ 
  ...
  const colors = {
    slate: 'bg-slate-200/80 dark:bg-[#2a2a2a] text-slate-600 dark:text-slate-400 hover:bg-slate-300 dark:hover:bg-[#333]',
